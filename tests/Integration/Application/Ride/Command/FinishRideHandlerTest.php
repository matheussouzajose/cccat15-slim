...
class FinishRideHandlerTest extends DatabaseTestCase
{
    ...
    public function test_should_be_finish_ride()
    {
        ...
        $inputFinishRide = new FinishRide(rideId: $outputRequestRide->rideId);
        ($this->finishRideHandler)(command: $inputFinishRide);
        $outputGetRide = ($this->getRideQuery)(rideId: $outputRequestRide->rideId);
        $this->assertEquals('completed', $outputGetRide[0]['status']);
    }
}
